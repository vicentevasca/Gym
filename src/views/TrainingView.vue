  ...
  <div>
    ...
    <main class="page-content px-4">
      <div class="card coming-soon">
        <p class="cs-label">Entrenamiento</p>
        <p class="cs-body">Sesión activa, ejercicios, series, RecordBadge y RestTimer.</p>
        <p class="cs-sub">Fase 2 →</p>
      </div>
    </main>
    <BottomNav />
  </div>
...
.cs-sub { font-size: 12px; color: var(--faint); margin-top: 4px; }
</style>
